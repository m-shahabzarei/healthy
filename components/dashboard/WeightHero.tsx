  ...
  return (
    <section className="dashboard-hero surface" dir="ltr">
      <div className="dashboard-hero-main">
        <div className="hero-card-label"><span className="mono-label">LATEST CHECK-IN</span><span className="hero-live-dot" /> Today</div>
      ...
      <div className="dashboard-hero-side">
        ...
        <div className="hero-goal-meta"><span>Start: {formatNumber(user.goal.startWeightKg)} kg</span><span>{progress >= 100 ? 'Goal reached' : `${formatNumber(Math.max(0, user.goal.startWeightKg - current))} kg to lose`}</span></div>
