...
import { getServerSnapshot, getSnapshot, getUserWeights, subscribe } from '@/lib/store';

export default function ProgressPage() {
  const snapshot = useSyncExternalStore(subscribe, getSnapshot, getServerSnapshot); const user = snapshot.currentUser; const userId = user?.id ?? '';
